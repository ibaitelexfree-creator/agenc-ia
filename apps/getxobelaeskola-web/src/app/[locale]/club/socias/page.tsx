...
export default function ClubSociasPage() {
    ...
    return (
        <main className="min-h-[100dvh] w-full bg-nautical-black text-sea-foam selection:bg-accent selection:text-nautical-black">
            {/* Cinematic Hero */}
            <section className="relative pt-20 max-md:pt-[calc(2.5rem+8vh)] max-md:landscape:pt-[calc(2rem+8vh)] md:pt-32 lg:pt-36 pb-10 max-md:landscape:pb-10 md:pb-28 overflow-hidden bg-nautical-deep w-full">
                ...
                <div className="w-full px-4 sm:px-6 md:container md:mx-auto md:px-6 relative z-10 text-center max-md:mt-[8vh]">

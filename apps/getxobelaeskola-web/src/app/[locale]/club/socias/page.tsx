...
export default function ClubSociasPage() {
    ...
    return (
        <main className="min-h-[100dvh] w-full bg-nautical-black text-sea-foam selection:bg-accent selection:text-nautical-black">
            {/* Cinematic Hero */}
            <section className="relative pt-10 landscape:pt-8 sm:pt-16 md:pt-32 lg:pt-36 pb-10 landscape:pb-10 md:pb-28 overflow-hidden bg-nautical-deep w-full -mt-[0.5vh] lg:mt-0">
                ...
                <div className="w-full px-4 sm:px-6 lg:container lg:mx-auto lg:px-6 relative z-10 text-center">
                    <header className="w-full max-w-full lg:max-w-4xl mx-auto space-y-2.5 landscape:space-y-2.5 md:space-y-6">
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-brass-gold/10 border border-brass-gold/20 text-brass-gold text-[10px] sm:text-xs font-black tracking-widest uppercase mb-1 md:mb-4 animate-fade-in-up">
                            <Sparkles className="w-3 h-3 sm:w-3.5 sm:h-3.5" />
                            {t('title')}
                        </span>
                        <h1 className="text-[clamp(1.35rem,3.8vw,4rem)] lg:text-[clamp(2.5rem,6vw,5.5rem)] font-display text-sea-foam leading-[1.1] lg:leading-[1.05] uppercase w-full">
                            {t('hero_title_part1')} <br className="hidden sm:inline" />
                            <span className="italic font-light text-accent/90">{t('hero_title_part2')}</span>
                        </h1>
                        <p className="w-full max-w-full lg:max-w-2xl lg:mx-auto text-foreground/70 font-light text-xs sm:text-sm md:text-base lg:text-xl leading-relaxed border-l-2 border-sea-foam/10 pl-3 md:pl-12 lg:pl-12 mt-3 md:mt-8 text-left md:text-center">
            ...
            <section className="py-8 landscape:py-10 md:py-24 relative overflow-hidden w-full">
                <div className="w-full px-4 sm:px-6 lg:container lg:mx-auto lg:px-6">
                    <StaggeredEntrance type="slide" className="grid grid-cols-1 landscape:grid-cols-2 lg:grid-cols-12 gap-5 lg:gap-16 items-center w-full">
                        <div className="landscape:col-span-1 lg:col-span-6 w-full">
                            <div className="relative aspect-[3/2.03] lg:aspect-[3/2] w-full border-2 border-sea-foam/30 overflow-hidden shadow-2xl group bg-nautical-deep rounded-xl lg:rounded-none scale-y-[1.01] lg:scale-y-100">
                                <Image
                        ...
                        <div className="landscape:col-span-1 lg:col-span-6 space-y-3 md:space-y-8 w-full max-w-full">
                            ...
                            <p className="text-foreground/80 font-light text-xs sm:text-sm md:text-base lg:text-lg leading-relaxed w-full max-w-full">
                                {t('description1')}
                            </p>
                        </div>
                    </StaggeredEntrance>
            ...
            <section className="py-12 landscape:py-14 md:py-32 relative bg-sea-foam/[0.02] border-t border-sea-foam/10 w-full">
                <div className="w-full px-4 sm:px-6 lg:container lg:mx-auto lg:px-6">
                    <header className="mb-8 md:mb-24 text-center w-full max-w-full">
                        <span className="text-accent uppercase tracking-[0.4em] lg:tracking-[0.5em] text-[10px] sm:text-xs font-black mb-2 md:mb-4 block">{t('benefits_eyebrow')}</span>
            ...
            <section className="py-14 landscape:py-14 md:py-32 relative bg-nautical-deep overflow-hidden border-t border-sea-foam/10 text-center w-full">
                ...
                <div className="w-full px-4 sm:px-6 lg:container lg:mx-auto lg:px-6 relative z-10 space-y-6 md:space-y-12">
                    <h2 className="text-xl landscape:text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-display uppercase tracking-tight w-full">
                        {t('cta_title')}
                    </h2>
                    <p className="text-sea-foam/60 text-xs sm:text-sm md:text-base lg:text-lg font-light w-full max-w-2xl lg:max-w-xl mx-auto leading-relaxed">
                        {t('cta_desc')}
                    </p>
                    <div className="pt-3 md:pt-6">
                        <Link
                            href="/contacto/localizacion"
                            className="inline-flex items-center gap-2.5 lg:gap-3 border border-accent bg-accent/5 px-7 py-3.5 lg:px-10 lg:py-5 rounded-full text-[11px] lg:text-xs uppercase tracking-[0.25em] lg:tracking-[0.3em] font-black text-accent hover:bg-accent hover:text-nautical-black transition-premium shadow-lg shadow-accent/15 group"
                        >
                            {t('cta_button')}
                            <ChevronRight className="w-3.5 h-3.5 lg:w-4 lg:h-4 transition-transform group-hover:translate-x-1" />
                        </Link>
                    </div>
                </div>
            </section>

    ...
    try {
        ...
        if (!services || services.length === 0) {
            services = [
                ...
                { id: '8', slug: 'alquiler-laser', nombre: 'Laser', nombre_es: 'Laser', nombre_eu: 'Laser', descripcion: 'Embarcación de vela ligera tipo Laser', imagen_url: '/images/alquiler-laser-new.jpg', precio_base: 35, activo: true, categoria: 'veleros' },

    ...
    try {
        ...
        if (!services || services.length === 0) {
            services = [
                ...
                { id: '9', slug: 'alquiler-j80', nombre: 'Veleros J80', nombre_es: 'Veleros J80', nombre_eu: 'J80 Belaontziak', descripcion: 'Crucero J80', imagen_url: '/images/j80-con-patron.jpg', precio_base: 60, activo: true, categoria: 'veleros' },

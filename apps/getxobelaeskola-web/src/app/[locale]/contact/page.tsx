                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-32 items-start">
                    ...
                    <div className="animate-fade-in" style={{ animationDelay: '0.2s' }}>
                        <header className="mb-20">
                            ...
                            <h1 className="text-4xl md:text-[8rem] font-display text-black leading-[0.9] mb-12">
                                {t('header_title')} <br />
                        ...
                        <div className="space-y-16">
                            <div className="group space-y-4">
                                ...
                                <p className="text-3xl font-display italic leading-tight whitespace-pre-line text-black/80 group-hover:text-black transition-colors duration-500">{t('location_val')}</p>
                            </div>
                            ...
                            <div className="group space-y-4">
                                ...
                                <div className="space-y-2">
                                    <a href="mailto:info@getxobelaeskola.com" className="text-3xl font-display italic text-black/80 hover:text-accent transition-colors duration-500 tracking-wide block">
                                        info@getxobelaeskola.com
                                    </a>
                                    <a href="tel:+34944916632" className="text-3xl font-display italic text-black/80 hover:text-accent transition-colors duration-500 tracking-wider block">
                                        (+34) 944 916 632
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="group space-y-4">
                                ...
                                <p className="text-3xl font-display italic leading-tight whitespace-pre-line text-black/80 group-hover:text-black transition-colors duration-500 tracking-wide">{t('hours_val')}</p>
                            </div>
                        </div>

                        {/* Social Links or Extra Decor */}
                        <div className="mt-24 pt-24 border-t border-black/10 flex gap-12 text-xs uppercase tracking-[0.3em] font-light">
                            <a href="https://www.instagram.com/pakeabelaeskola/" target="_blank" rel="noopener noreferrer" className="text-foreground/40 hover:text-black transition-colors">Instagram</a>
                            <a href="https://www.facebook.com/Pakea.bela.eskola/" target="_blank" rel="noopener noreferrer" className="text-foreground/40 hover:text-black transition-colors">Facebook</a>
                        </div>
                    </div>

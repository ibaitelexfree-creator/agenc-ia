...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }): Promise<Metadata> {
  ...
  if (isEu) {
    ...
    title = 'Home | Getxo Bela Eskola';
    description = 'Welcome to Getxo Bela Eskola. Learn to sail, rent equipment and live unforgettable nautical experiences in Getxo Marina.';
  } else if (isFr) {
    title = 'Accueil | Getxo Bela Eskola';
    description = 'Bienvenue à Getxo Bela Eskola. Apprenez la voile, louez du matériel et vivez des expériences nautiques inoubliables à Getxo.';
  }
    ...
    <div className="w-full">
      ...
      <h1 className="sr-only">
        {locale === 'eu' ? 'Getxo Bela Eskola | Bela Eskola Getxon' :
          locale === 'en' ? 'Getxo Bela Eskola | Sailing Lessons in Getxo' :
            locale === 'fr' ? 'Getxo Bela Eskola | École de Voile à Getxo' :

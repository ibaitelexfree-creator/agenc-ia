...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: getSeoAlternates('home-10', locale),
  };
}
...
export default async function Home10Page({ params: { locale } }: { params: { locale: string } }) {
  const jsonLd = {
    ...
    "url": "https://getxobelaeskola.cloud/home-10",
  ...
  return (
    <div className="w-full">
      ...
      <HomePrototypeLayout variant="home-10" waveVariant="animated-organic" blobsElevated={7} />

...
import { Wind, Waves, Eye, ThermometerSun, AlertTriangle } from 'lucide-react';
    ...
    return (
        <div className="bg-white text-nautical-black rounded-sm shadow-lg border border-gray-300 overflow-hidden font-mono text-sm">
            ...
            <div className="bg-blue-900 text-white p-4 flex justify-between items-center">
                <div>
                    <h2 className="text-xl font-bold uppercase tracking-wider">Boletín Meteorológico</h2>
                    <p className="text-xs opacity-80">getxobelaeskola Estatal de Meteorología</p>
                </div>
            ...
            <div className="p-4 border-b border-gray-200 bg-gray-50">
                <h3 className="font-bold uppercase text-xs text-gray-500 mb-1">Situación Sinóptica</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x border-gray-200">
                <div className="p-4 space-y-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <span className="block font-bold text-gray-500 text-xs uppercase">Viento</span>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <span className="block font-bold text-gray-500 text-xs uppercase">Estado de la Mar</span>
                ...
                <div className="p-4 space-y-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <span className="block font-bold text-gray-500 text-xs uppercase">Visibilidad</span>
                    ...
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <span className="block font-bold text-gray-500 text-xs uppercase">Presión / Tendencia</span>

    ...
    <section className="bg-[#F5F5F7] py-32 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <motion.p
          ...
          className="text-[#86868B] text-xs uppercase tracking-[0.25em] mb-6 font-sans"
        >
          {t("cta_eyebrow")}
        </motion.p>
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
          className="text-[#1D1D1F] leading-tight mb-6 font-bold"
          style={{
        ...
        <motion.p
          ...
          className="text-[#86868B] text-lg mb-12 max-w-lg mx-auto font-sans"
        >
          {t("cta_subtitle")}
        </motion.p>
        ...
        >
          <Link
            href={`/${locale}/courses`}
            className="inline-block bg-[#0071E3] text-white font-medium text-sm font-sans
          ...
          <Link
            href={`/${locale}/courses`}
            className="inline-block bg-transparent text-[#0071E3] font-medium text-sm font-sans
